...
const Hero = () => {
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center items-center text-center px-4 pt-24 md:pt-32">
      ...
      {/* 3. НОВАЯ: Маленькая голубая звездочка - СКРЫТА НА МОБИЛКАХ */}
      ...
      {/* 4. НОВАЯ: Крошечная белая звездочка - СКРЫТА НА МОБИЛКАХ */}
      ...
      <div className="max-w-6xl mx-auto z-10 relative w-full">
        <h1 className="font-sans font-bold tracking-tight leading-[1.1] mb-6 sm:mb-8 flex flex-col items-center">
          {/* Первая строка: жесткая однострочность, размер зависит от ширины экрана на мобилках */}
          <span className="block whitespace-nowrap text-[7.5vw] sm:text-[3.5rem] md:text-[4.5rem] lg:text-[5.5rem]">
            Precision in every frame.
          </span>
          {/* Вторая строка: тоже жесткая однострочность */}
          <span className="block whitespace-nowrap font-serif italic font-normal text-gray-200 tracking-normal text-[6.5vw] sm:text-[3.5rem] md:text-[4.5rem] lg:text-[5.5rem] mt-1 sm:mt-3 lg:mt-5">
            Storytelling driven by rhythm.
          </span>
        </h1>
        
        {/* Абзац: увеличен line-height (leading-[1.6]) для читаемости */}
