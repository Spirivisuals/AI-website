...
const Hero = () => {
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center items-center text-center px-4 pt-24 md:pt-32">
      ...
      <div className="absolute top-[27%] left-[3%] sm:top-[15%] sm:left-[8%] md:top-[18%] md:left-[15%] lg:top-[20%] lg:left-[20%] text-cyan-400 opacity-100 animate-pulse pointer-events-none drop-shadow-[0_0_15px_rgba(34,211,238,0.8)]">
      ...
      <div className="absolute top-[70%] right-[5%] sm:top-[20%] sm:right-[10%] md:top-[22%] md:right-[15%] lg:top-[25%] lg:right-[18%] text-gray-100 opacity-90 animate-pulse delay-700 pointer-events-none drop-shadow-[0_0_12px_rgba(255,255,255,0.7)]">
      ...
      <div className="max-w-6xl mx-auto z-10 relative w-full">
        <h1 className="font-sans font-bold tracking-tight leading-[1.1] mb-6 sm:mb-8 flex flex-col items-center">
          ...
          {/* Вторая строка: Seamless motion. (Чуть меньше первой, чтобы 100% влезла в мобильный экран) */}
        ...
        <p className="text-[16px] sm:text-[17px] md:text-2xl text-gray-400 mb-12 sm:mb-16 max-w-2xl mx-auto font-light leading-[1.6] md:leading-relaxed px-2 sm:px-0">
          Advanced video editing and motion graphics. Turning raw footage into pure, engaging storytelling.
        </p>
