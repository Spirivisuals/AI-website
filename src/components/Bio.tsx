...
const Bio = () => {
  ...
  return (
    {/* Уменьшены общие вертикальные отступы секции для экономии места на экране */}
    <section className="py-16 md:py-20 px-4 sm:px-6 w-screen">
      <div className="max-w-3xl mx-auto flex flex-col items-center text-center">
        <div className="flex flex-col items-center w-full">
          
          {/* Photo: уменьшен размер (было md:w-48, стало md:w-36) и нижний отступ */}
          ...
          {/* Заголовок: уменьшены размеры на всех экранах */}
        ...
        {/* Текст: слегка уменьшен межстрочный интервал между абзацами */}
        ...
        {/* Теги программ: отступ сверху уменьшен (mt-6 md:mt-8 вместо mt-8 md:mt-12) */}
